...
class FibonacciTabulationTest {
    private final FibonacciTabulation subject = new FibonacciTabulation();
    ...
    @Test
    @DisplayName("f(42) should take less than a millisecond (faster than naive approach)")
    void testCase6() {
        ...
        assertThat(elapsedTime).isLessThan(1);
    }
}